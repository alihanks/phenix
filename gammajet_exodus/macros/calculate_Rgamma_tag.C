...
void calculate_Rgamma_tag(){
  ...
  for(int i=0; i<4; i++){
    ...
    */
    ...
    float etag=(Ninc[i]-Nleft[i])/Ninc[i]+(1-sep_eff)/Rgamma*0.74;
    ...
    */
    ...
    Rtagerr[i]=Rerr*(1-etag)/((Nfl[i]/Ntag[i]-1.0)*Rgamma*etag+1)/((Nfl[i]/Ntag[i]-1.0)*Rgamma*etag+1);

    Rtagsys[i]=Rerrcorr*(1-etag)/((Nfl[i]/Ntag[i]-1.0)*Rgamma*etag+1)/((Nfl[i]/Ntag[i]-1.0)*Rgamma*etag+1);


    //Rtagerr[i]=Rerr*(Nleft[i]/Ninc[i])/((Nfl[i]/Ntag[i]-1.0)*Rgamma*(Ninc[i]-Nleft[i])/Ninc[i]+1)/((Nfl[i]/Ntag[i]-1.0)*Rgamma*(Ninc[i]-Nleft[i])/Ninc[i]+1);

    //Rtagsys[i]=Rerrcorr*(Nleft[i]/Ninc[i])/((Nfl[i]/Ntag[i]-1.0)*Rgamma*(Ninc[i]-Nleft[i])/Ninc[i]+1)/((Nfl[i]/Ntag[i]-1.0)*Rgamma*(Ninc[i]-Nleft[i])/Ninc[i]+1);
 ...
 const char* outfile = "Rgamma_tag_030209_etag.root";
