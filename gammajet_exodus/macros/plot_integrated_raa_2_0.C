void plot_integrated_raa_2_0()
{
  ...
  float raa_e[4]          = {0.434, 0.576, 0.498, 0.557};
  float stat_e[4]         = {0.029, 0.040, 0.039, 0.073};
  float e_raa_e_cent[4]   = {0.066, 0.096, 0.091, 0.115};
  float e_raa_e_nocent[4] = {0.163, 0.216, 0.200, 0.240};
  /*
  ...
  */
  ...
  //raa_electron_stat->Fit("pol0");

  TLatex *electron = new TLatex(200.,1.3,"(e^{+}+e^{-})/2: R_{AA}^{2.0 - 5.0}");
