void plot_integrated_raa_3_0()
{
  ...
  float raa_e[4]          = {0.271, 0.352, 0.330, 0.485};
  float stat_e[4]         = {0.053, 0.071, 0.069, 0.143};
  float e_raa_e_cent[4]   = {0.038, 0.055, 0.053, 0.080};
  float e_raa_e_nocent[4] = {0.114, 0.148, 0.143, 0.213};
  /*
  ...
  */
  ...
  TLatex *electron = new TLatex(200.,1.3,"(e^{+}+e^{-})/2: R_{AA}^{3.0 - 5.0}");  electron->SetTextColor(4);
