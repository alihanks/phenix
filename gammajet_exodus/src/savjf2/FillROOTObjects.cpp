		     ...
		     ParticlePropertyList *PPList)
{
  ...
  //newest taxi
  char deadfile[]="/direct/phenix+u/workarea/mjuszkie/gammajet_exodus/livetowers_r7_taxi230.list";
  
  //run10 
  //  char deadfile[]="/phenix/hhj/jfrantz/gammajet_exodus/livetowers_r10_v2.dat";
